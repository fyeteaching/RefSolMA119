...
format: 
  html:
    abstract: "Those references solutions are for MA119 final review of QCC. A pdf version can be found at <https://fyemath.github.io/RefSolMA119/main.pdf>. Please let me know if you see any mistakes. Thank you!"
    # theme: pandoc
    header-includes: |
  ...
  pdf:
    abstract: "Those references solutions are for MA119 final review of QCC. A html version can be found at <https://fyemath.github.io/RefSolMA119/index.html>. Please let me know if you see any mistakes. Thank you!" 
...
38. The $x$-intercepts have the $y$-coordinate $0$. To get their $x$-coordinates, solve the equation $-x^2+4x+5=0$.
    ...
    ![Graph of $y=-x^2+4x+5](parabola.png)
